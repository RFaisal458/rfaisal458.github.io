    function preloader() {
        console.log("ok")
        document.querySelector(".preloader").style = "opacity:0;visibility:hidden;"
    }
    ...
    btn.addEventListener("click", function() {
        ...
        document.querySelector("title").text = "Happy Birthday:)!!!"
        let audio = document.getElementById("audioHappy")
        audio.volume = 0.2
        audio.play();
        document.querySelector(".layer").style = "display:none"
        document.querySelector(".bg-dark-layer").style = "display:block"
